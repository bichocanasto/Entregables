...
electro4 = Electrodomestico(150,"MAGENTA","F",100)
lava01 = Lavadora(10,500,"AZUL","B",65)
lava02 = Lavadora(6,250,"BLANCO", "D",90)
lava03 = Lavadora(15,1000,"NEGRA","A",55)
...
arrayelectro.append(electro4)
arrayelectro.append(lava01)
arrayelectro.append(lava02)
arrayelectro.append(lava03)
...
for i in range (len(arrayelectro)):
    print(arrayelectro[i].precioFinal())
    print(arrayelectro[i])
    precioElectro += arrayelectro[i].get_precioBase()
    if hasattr(arrayelectro[i], "carga") == True: 
        precioLava += arrayelectro[i].get_precioBase()
    if hasattr(arrayelectro[i], "resolucion") == True: 
        precioTele += arrayelectro[i].get_precioBase()


#3.8.4: Deberás mostrar el precio de cada clase, es decir, el precio de todas las
#televisiones por un lado, el de las lavadoras por otro y la suma de los Electrodomesticos (puedes crear objetos Electrodomestico, pero recuerda que Television y Lavadora también son electrodomésticos).
...
print("Precio de los electrodomesticos: " + str(precioElectro))
print("Precio de los televisores: " + str(precioTele))
print("Precio de las lavadoras: " + str(precioLava))
